...
def generate_launch_description():
    launch_args = [
        ...
        DeclareLaunchArgument(
            "model_path",
            default_value="./install/edgeyolo_ros_cpp/share/edgeyolo_ros_cpp/weights/openvino/edgeyolo_nano.xml",
    ...
    container = ComposableNodeContainer(
                ...
                composable_node_descriptions=[
                    ...
                    ComposableNode(
                        package='edgeyolo_ros_cpp',
                        plugin='edgeyolo_ros_cpp::EdgeYOLONode',
